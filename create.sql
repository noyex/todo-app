...
create table users (enabled bit not null, created_at datetime(6) not null, id bigint not null auto_increment, last_login_date datetime(6), verification_expiration datetime(6), username varchar(50) not null, mail varchar(255) not null, password varchar(255) not null, verification_code varchar(255), role enum ('ADMIN','PREMIUM_USER','USER'), primary key (id)) engine=InnoDB;
